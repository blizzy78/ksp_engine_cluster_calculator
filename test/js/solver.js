...
test('solveStack - no vectoring required', function() {
	var engineConfigs = solveStack(190, 220, 0, 0, 0, 0, true, false, 5, false);
...
test('solveStack - vectoring required', function() {
	var engineConfigs = solveStack(190, 220, 0, 0, 0, 0, true, true, 5, false);
...
test('solveStack - with outer engines', function() {
	var engineConfigs = solveStack(599, 601, 0, 4, 0, 0, true, true, 5, false);
	equal(engineConfigs.length, 2);
...
test('solveStack - with outer and radial engines', function() {
	var engineConfigs = solveStack(639, 641, 0, 4, 0, 4, true, true, 5, false);
	equal(engineConfigs.length, 2);
...
test('solveStack - with radial engines', function() {
	var engineConfigs = solveStack(239, 241, 0, 4, 0, 4, true, true, 5, false);
	equal(engineConfigs.length, 1);
...
test('solveStack - no balance required', function() {
	var engineConfigs = solveStack(234, 236, 0, 4, 0, 4, false, false, 5, false);
	equal(engineConfigs.length, 2);
